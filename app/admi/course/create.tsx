...
const CourseCreate = () => {
    return (
        <Create className='flex items-center justify-center'>
            ...
            <h1 className='font-bold text-muted-foreground text-xl lg:text-3xl text-center '>Create Course</h1>
            <p className='text-xs text-muted-foreground text-center'>Create a professional and advance course for your client.</p>
