...
const ChallengeCreate = () => {
    return (
        <Create className='flex items-center justify-center'>
            ...
            <h1 className='font-bold text-muted-foreground text-xl lg:text-3xl text-center '>Create Challenge</h1>
            <p className='text-xs text-muted-foreground text-center'>Generate some challenges.</p>
