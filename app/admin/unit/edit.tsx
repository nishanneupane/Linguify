...
const UnitEdit = () => {
    return (
        <Edit className='flex items-center justify-center'>
            ...
            <h1 className='font-bold text-muted-foreground text-xl lg:text-3xl text-center '>Edit Unit</h1>
            <p className='text-xs text-muted-foreground text-center'>Edit your unit</p>
